...
class APIUser(FastHttpUser):
    ...
    @task
    def predict(self):
        self.client.post("/predictions/doesntmatter", json=self._random_data())

# curl -X POST "http://127.0.0.1:20895/predictions/doesntmatter" -d '[{"data": $(base64 -w 0 "tests/test.png")}, {"data": $(base64 -w 0 "tests/test.png")}]'